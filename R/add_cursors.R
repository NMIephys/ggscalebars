...
#' @param annot_under similar to annot, but drawn *under* the traces.  #fixme does this work?   
#' @param filter_fun filter_fun to be applied to the default stream, if autogenerated #fixme good idea?  
#' @param filter_fun2 filter_fun2 to be applied to the default stream, if autogenerated #fixme good idea?  
